...
Shared reference for the canonical TODOS.md format. Referenced by `/ship` and the astack planning workflow when updating TODO items to ensure consistent structure.
