...
## Step 1.6: Bootstrap the enhancement branch

If the current branch is `main`, move the enhancement work onto a fresh branch
before you start writing the scope:
