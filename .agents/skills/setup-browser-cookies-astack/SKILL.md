---
name: setup-browser-cookies-astack
version: 1.0.0
description: |
...
echo '{"skill":"setup-browser-cookies-astack","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null || echo "unknown")'"}'  >> ~/.astack/analytics/skill-usage.jsonl 2>/dev/null || true
...
If the user specifies a domain directly (e.g., `/setup-browser-cookies-astack github.com`), skip the UI:
