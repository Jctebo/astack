...
description: |
  ...
  Combines /careful-astack (warns before rm -rf, DROP TABLE, force-push, etc.) with
  /freeze-astack (blocks edits outside a specified directory). Use for maximum safety
...
# /guard-astack — Full Safety Mode

Activates both destructive command warnings and directory-scoped edit restrictions.
This is the combination of `/careful-astack` + `/freeze-astack` in a single command.

**Dependency note:** This skill references hook scripts from the sibling `/careful-astack`
...
- "To remove the edit boundary, run `/unfreeze-astack`. To deactivate everything, end the session."

## What's protected

See `/careful-astack` for the full list of destructive command patterns and safe exceptions.
See `/freeze-astack` for how edit boundary enforcement works.
