...
## Step 1.5: Ensure the enhancement branch

If the current branch is `main`, move the implementation work onto a fresh
branch before you start editing code:

1. Derive the branch name from the active enhancement slug: `enhancement/<slug>`.
