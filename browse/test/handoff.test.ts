...
import { describe as bunDescribe, test, expect, beforeAll, afterAll } from 'bun:test';
...
const browserDescribe = process.platform === 'win32' ? bunDescribe.skip : bunDescribe;
...
browserDescribe('handoff edge cases', () => {
...
browserDescribe('handoff integration', () => {
